...
namespace Workbench\App\Entities\Articles\Status\Events;
...
#[Alias('article.status.publishing')]
final class Publishing implements ForEntity, RecordableAfterCommit
{
    use Dispatchable;
    use HasEntity;
    use HasLoggable;
