...
final class ControllerTest extends TestCase
{
    ...
    public function it_resolves_namespace_for_rest_endpoint(): void
    {
        $controller = Controller::make(
            Route::make('V1', $this->entity, EndpointType::Rest, Endpoint::Index->value),
        );
    ...
    {
        $show = Controller::make(Route::make('V1', $this->entity, EndpointType::Rest, Endpoint::Show->value, scope: Scope::Instance));
        $index = Controller::make(Route::make('V1', $this->entity, EndpointType::Rest, Endpoint::Index->value, scope: Scope::Resource));
